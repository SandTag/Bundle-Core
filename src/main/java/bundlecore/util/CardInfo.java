...
public class CardInfo {
    ...
    public int SetBonusThreshold = 0;
    ...
    public CardInfo(String baseId, int baseCost, AbstractCard.CardType cardType, AbstractCard.CardTarget cardTarget, AbstractCard.CardRarity cardRarity, AbstractCard.CardColor cardColor, int SetBonusThreshold)
    {
        this.baseId = baseId;
        this.baseCost = baseCost;
        this.cardType = cardType;
        ...
        this.cardRarity = cardRarity;
        this.cardColor = cardColor;
        this.SetBonusThreshold = SetBonusThreshold;
    }
}