...
/**
 * This is already handled by bundlecore, instead implement abstracts like BundleRelic or AbstractCustomImagePotion.
 */
...
public class TextureLoader {
    ...
    public static String getExternalCardTextureString(final String cardName, final AbstractCard.CardType cardType, final String OriginLocation)
    {
        String textureString =  OriginLocation+("cards/" + cardType.name().toLowerCase(Locale.ROOT) + "/" + cardName + ".png");
        FileHandle h = Gdx.files.internal(textureString);
        if (!h.exists())
        {
            switch (cardType) {
