package bundlecore.events.enemies;
...
public class LagavulinCloneEnemy extends AbstractMonster {
    private static final Logger logger = LogManager.getLogger(Lagavulin.class.getName());
    public static final String ID = "LagavulinCloneEnemy";
    ...
    /**
     * A mirror of lagavullin used by Bundle of Peglin for the waterfall event.
     */
    @Dont_Use_This_Externally
    public LagavulinCloneEnemy(boolean setAsleep, float x, float y) {
        super(NAME, "Lagavulin", 111, 0.0F, -25.0F, 320.0F, 220.0F, null, x, y);
