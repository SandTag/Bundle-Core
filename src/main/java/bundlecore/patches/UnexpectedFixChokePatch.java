...
/**
 * Fixes a bug with choke power amount stacking.
 */
@Deprecated
//todo: remove after basemod merges it.
public class UnexpectedFixChokePatch {
    ...
    public static class AddUpdateOverride {
        ...
        public static void addMethod(CtBehavior ctMethodToPatch) throws CannotCompileException, NotFoundException {
            ...
            updateMethod.insertAfter(UnexpectedFixChokePatch.class.getName()+".fixDesc($0);");
        }
    }
