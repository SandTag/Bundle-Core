...
/**
 * A modifier that reduces cost and adds a burn after use.
 */
public class ScaldingModifier extends AbstractAugment {
    public static final String ID = BundleCoreMain.makeID(ScaldingModifier.class.getSimpleName());
    ...
    public AbstractCardModifier makeCopy() {
        return new ScaldingModifier();
    }

    @Override
    public void onUse (AbstractCard card, AbstractCreature target, UseCardAction action){
        GFL.atb(new MakeTempCardInDiscardAction(new Burn(), 1));
    }
